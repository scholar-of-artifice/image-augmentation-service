...
from app.schemas.image import ResponseUploadImage, ResponseAugmentImage, AugmentationRequestBody,ShiftArguments

pytestmark = pytest.mark.asyncio

async def test_augment_an_image_201(http_client):
    """
    This test augments an unprocessed image.
    1. Create a user
    2. Upload an image
    3. Augment an image
    """
    ...
    # ResponseAugmentImage.model_validate(augment_response.json())
